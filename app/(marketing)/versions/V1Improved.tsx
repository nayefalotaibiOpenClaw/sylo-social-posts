  ...
  return (
    <div className="relative w-full h-48 rounded-2xl bg-slate-50 border border-slate-100 overflow-hidden p-6">
      ...
      >
        ...
        <span className="text-sm text-slate-500">Brand font:</span>
      ...
      >
        ...
        <span className="text-sm text-slate-500">Products found:</span>
        <span className="text-sm font-semibold text-slate-800">12 items</span>
        <motion.div
      ...
      >
        ...
        <span className="text-sm text-slate-500">Backgrounds:</span>
        <span className="text-sm font-semibold text-slate-800">Removed & cleaned</span>
      </motion.div>
    </div>
  );
}
...
function InteractiveDemo() {
  ...
  const stepLabels: Record<DemoStep, string> = {
    idle: "Paste your website or product URL",
    scanning: "Scanning your website & products...",
    extracting: "Extracting brand colors, fonts & product images...",
    generating: "Generating ads, social posts & app store previews...",
  };
...
const steps = [
  {
    ...
    description: "We scan your website, extract your brand identity, and pull all your products automatically.",
  },
  {
    icon: Scissors,
    title: "Clean & prepare",
    description: "AI removes product backgrounds, extracts brand colors, fonts, and logos — ready to create.",
  },
  {
    icon: Sparkles,
    title: "Generate everything",
    description: "Ads, social posts, app store previews, stories — AI creates on-brand content for every format.",
  },
  {
    icon: Send,
    title: "Publish to all channels",
    description: "Push directly to Instagram, TikTok, Facebook, X, App Store, Google Play — one click.",
  },
];
...
const features = [
  {
    ...
    description: "Paste your URL and we auto-detect your colors, fonts, logo, and visual identity.",
  },
  {
    icon: Scissors,
    title: "Background Removal",
    description: "Product images cleaned up automatically — no Photoshop, no manual work.",
  },
  {
    icon: Sparkles,
    title: "AI Copywriting",
    description: "On-brand headlines, captions, and CTAs generated from your actual products.",
  },
  {
    icon: FlaskConical,
    title: "A/B Ad Creatives",
    description: "Generate dozens of ad variants from your product catalog to find what converts.",
  },
  {
    icon: Layers,
    title: "App Store Previews",
    description: "All screenshot sizes for iOS App Store and Google Play — generated instantly.",
  },
  {
    icon: MonitorSmartphone,
    title: "Publish to Every Channel",
    description: "Push directly to Instagram, TikTok, Facebook, X, and app stores via API.",
  },
];
...
/* ─── Main Component ─── */
export default function V1Improved() {
  return (
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      ...
      <Section className="pt-36 pb-20 md:pt-44 md:pb-28">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05]">
            ...
            <br />
            <span className="text-slate-400">Every format. Every channel.</span>
          </h1>
          <p className="mt-5 text-lg md:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed">
            Paste your URL — we extract your brand, pull your products, remove backgrounds, and generate social posts, app store previews, and ad creatives. Then publish directly to every channel.
          </p>
        </motion.div>
      ...
      <Section className="py-20 md:py-28" id="use-cases">
        <SectionHeader
          label="From one URL"
          title="Ads. Social. App Store. Done."
          subtitle="Your brand and products turned into ready-to-publish content for every platform and format."
        />
        <UseCaseTabs />
      </Section>
      ...
      <Section className="py-20 md:py-28 bg-slate-50/50" id="how-it-works">
        <SectionHeader
          label="How it works"
          title="URL to published in under a minute"
          subtitle="Brand extraction, product cleanup, content generation, and multi-channel publishing — fully automated."
        />
        <HowItWorks />
      </Section>
      ...
      <Section className="py-20 md:py-28" id="features">
        <SectionHeader
          ...
          title="From brand to published — fully automated"
          subtitle="Everything your team needs to turn products into content across every channel."
        />
        <FeaturesGrid />
      </Section>
      ...
      <Section className="py-20 md:py-28">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-black tracking-tight mb-4">
            Turn your products into content today
          </h2>
          <p className="text-slate-400 text-lg mb-8 max-w-md mx-auto">
            No credit card required. Paste your URL and watch your brand come to life.
          </p>
          <Link
            href="/login"
