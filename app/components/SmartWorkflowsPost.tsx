  ...
  return (
    <div className="relative w-full max-w-[600px] aspect-square shadow-2xl rounded-xl overflow-hidden mx-auto font-sans"
      ...
      <div className="relative z-10 w-full h-full flex flex-col p-8">
        ...
        <DraggableWrapper id="headline-workflows" className="mt-8 text-right z-30" dir="rtl">
        ...
        <div className="flex-1 flex items-center justify-center relative mt-4">
          <DraggableWrapper id="mockup-workflows" className={`relative z-20 transition-all duration-500 ${isTall ? 'w-[440px] h-[330px]' : 'w-[340px] h-[240px]'}`}>
          ...
          <FloatingCard 
            ...
            label="Daily Tasks" 
            value="100% Done" 
            className={`absolute -right-2 top-1/4 z-30 ${isEditMode ? '' : 'animate-float'}`} 
          ...
          <FloatingCard 
            ...
            label="Avg. Service" 
            value="-15% Time" 
            className={`absolute -left-4 bottom-1/4 z-30 ${isEditMode ? '' : 'animate-float-slow'}`} 
            rotate={-4}
          />
