    ...
    <div className="relative w-full h-full shadow-2xl rounded-xl overflow-hidden mx-auto font-sans"
      ...
      <div className="relative z-10 w-full h-full flex flex-col p-8">
        ...
        <div className="flex-1 flex items-center justify-center relative mt-4">
          <DraggableWrapper id="mockup-workflows" className={`relative z-20 transition-all duration-500 ${isTall ? 'w-[440px] h-[330px]' : 'w-[340px] h-[240px]'} ${isEditMode ? '' : 'animate-zoom-in animate-stagger-2'}`}>
