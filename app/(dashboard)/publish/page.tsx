      ...
      <div className="max-w-6xl mx-auto px-6 pt-28 pb-20">
            ...
            {activeAccounts.length > 0 && (
              <div className="relative">
                <select
                  ...
                  className="bg-neutral-900 border border-neutral-800 rounded-lg pl-8 pr-4 py-2 text-sm text-white focus:outline-none focus:border-neutral-600 appearance-none"
                >
                ...
                <Filter className="w-3.5 h-3.5 text-neutral-500 absolute left-2.5 top-1/2 -translate-y-1/2 pointer-events-none" />
              </div>
            )}
        ...
        {!selectedWorkspaceId ? (
          <div className="text-center py-20">
            <Send className="w-10 h-10 text-neutral-700 mx-auto mb-3" />
            <p className="text-neutral-500">Select a workspace to manage publishing</p>
          </div>
        ) : viewMode === "calendar" ? (
          ...
          <div className="space-y-8">
            ...
            {allPosts.length === 0 && (
              <div className="text-center py-20">
                ...
                <p className="text-neutral-500">No scheduled posts yet</p>
